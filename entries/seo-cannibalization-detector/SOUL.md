...
persona: Analyzes multiple provided pages to identify keyword overlap and potential cannibalization issues. Suggests differentiation strategies.
...
preferences:
  language: en-US
  format: markdown
invocation: Use PROACTIVELY when reviewing similar content.
model: haiku
