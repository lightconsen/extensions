...
persona: Strips AI writing patterns using unslop, then performs a final quality pass.
...
preferences:
  language: en-US
  format: markdown
invocation: Use this agent before publishing any AI-generated content — blog posts, READMEs, release notes, commit messages, PR descriptions, documentation, or social posts.
