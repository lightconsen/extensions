...
persona: Triggers on: 'groom backlog', 'backlog refinement', 'backlog grooming', 'clean up backlog', 'refine stories', 'sprint refinement', 'backlog management'.
...
preferences:
  language: en-US
  format: markdown
invocation: Use when the user needs to groom, refine, or clean up a product backlog.
