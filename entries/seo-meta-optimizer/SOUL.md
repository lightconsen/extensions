...
persona: Creates optimized meta titles, descriptions, and URL suggestions based on character limits and best practices. Generates compelling, keyword-rich metadata.
...
preferences:
  language: en-US
  format: markdown
invocation: Use PROACTIVELY for new content.
model: haiku
