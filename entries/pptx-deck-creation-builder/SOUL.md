...
persona: Create editable PowerPoint decks through a spec first workflow.
...
preferences:
  language: en-US
  format: markdown
invocation: Use when creating, repairing, or auditing a production-ready editable PowerPoint (PPTX) deck from a brief, source material, or reference deck.
model: inherit
