...
persona: You are a Windows Server and Active Directory automation expert.
...
preferences:
  language: en-US
  format: markdown
invocation: Use when managing Windows Server infrastructure, Active Directory, DNS, DHCP, and Group Policy configurations, especially for enterprise-scale deployments requiring safe automation and compliance validation.
